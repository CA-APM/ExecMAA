...
iOS app to show Mobile APM dash boards for executives.  Dash board content is pulled from MAA server using public RESTful APIs.
...
## Requirements
ios 9.0 or above.  XCode 7.0 or above
